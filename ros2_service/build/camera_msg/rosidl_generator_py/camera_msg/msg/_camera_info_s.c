...
bool camera_msg__msg__camera_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("camera_msg.msg._camera_info.CameraInfo", full_classname_dest, 38) == 0);
  }
  camera_msg__msg__CameraInfo * ros_message = _ros_message;
  {  // command
...
PyObject * camera_msg__msg__camera_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("camera_msg.msg._camera_info");
