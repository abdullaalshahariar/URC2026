...
static const _CameraStatus_Request_type_support_symbol_names_t _CameraStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera_msg, srv, CameraStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, camera_msg, srv, CameraStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, camera_msg, srv, CameraStatus_Request)() {
  return &::camera_msg::srv::rosidl_typesupport_c::CameraStatus_Request_message_type_support_handle;
}
...
static const _CameraStatus_Response_type_support_symbol_names_t _CameraStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera_msg, srv, CameraStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, camera_msg, srv, CameraStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, camera_msg, srv, CameraStatus_Response)() {
  return &::camera_msg::srv::rosidl_typesupport_c::CameraStatus_Response_message_type_support_handle;
}
...
static const _CameraStatus_Event_type_support_symbol_names_t _CameraStatus_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera_msg, srv, CameraStatus_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, camera_msg, srv, CameraStatus_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, camera_msg, srv, CameraStatus_Event)() {
  return &::camera_msg::srv::rosidl_typesupport_c::CameraStatus_Event_message_type_support_handle;
}
...
static const _CameraStatus_type_support_symbol_names_t _CameraStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera_msg, srv, CameraStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, camera_msg, srv, CameraStatus)),
  }
};
...
static const rosidl_service_type_support_t CameraStatus_service_type_support_handle = {
  ...
  &CameraStatus_Request_message_type_support_handle,
  &CameraStatus_Response_message_type_support_handle,
  &CameraStatus_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, camera_msg, srv, CameraStatus)() {
  return &::camera_msg::srv::rosidl_typesupport_c::CameraStatus_service_type_support_handle;
}
